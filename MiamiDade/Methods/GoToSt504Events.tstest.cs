...
namespace MiamiDade
{
    ...
    public class GoToSt504Events : BaseWebAiiTest
    {
        ...
        [CodedStep(@"ChooseURL 504 based on base url")]
          public void ChooseUrl_504()
        {
                ...
                String address = "/Plan/Students/ViewStudent?CommonStudentId="+studentID+"&studentViewType=Events&programType=Miami504";
